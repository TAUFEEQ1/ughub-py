...
- 🎯 Entry points to execute your program using `python -m <ughub_py>` or `$ ughub_py` with basic CLI argument parsing.
...
```py
from ughub_py import BaseClass
from ughub_py import base_function
